...
(function($) {
	$.fn.btsListFilter = function(inputEl, opts) {
		...
		opts = $.extend({
			...
			cancelNode: function() {
				return '<span class="btn glyphicon glyphicon-remove form-control-feedback" style="width: 0px ; ' +
					'    width: 0px;top:-10px ;right: -40px;" pointer-events: auto;" aria-hidden="true"></span>';
			},
